<?php
 $sqlsection= "SELECT * FROM sectionlist WHERE criteria ='75' && grade ='$grade' && schoolyear='$schoolyear'";
                                                ...
                                                $sqlcount = "SELECT count(id) FROM enrollmentform WHERE section = '$sectionname'&& schoolyear ='$schoolyear'";        
                                                        ...
                                                        while($rowcount = mysqli_fetch_array($resultcount))
                                                        {
                                                          ...
                                                          echo"<br>";
                                                           if($rowcount[0] >='2')
                                                              {
                                                                $sqlsection3= "SELECT * FROM sectionlist WHERE criteria ='75a' && grade ='$grade' && schoolyear='$schoolyear'";
                                                                                      ...
                                                                                      else
                                                                                      {
                                                                                        $query = "UPDATE enrollmentform SET sname='$surname', fname='$firstname', mname='$mname', email='$email', placeofbirth='$birthplace', gender='$gen', dateofbirth='$bday', age='$age', grade='$grade', father='$father', mother='$mother', motheroccupation='$motheroccupation', fatheroccupation='$occupation', fathercontact='$fathercontact', mothercontact='$mothercontact', address='$address', elementarygraduated='$grad',
                                                                                         ...
                                                                                         '$b',
                                                                                          ...
                                                                                          date=NOW(), kindofuser ='$kindofuser', schoolyear='$schoolyear', section='$sectionname3', adviser='$adviser3' WHERE username='$_SESSION[email]' ";
                                                              ...
                                                              {
                                                                 $query = "UPDATE enrollmentform SET sname='$surname', fname='$firstname', mname='$mname', email='$email', placeofbirth='$birthplace', gender='$gen', dateofbirth='$bday', age='$age', grade='$grade', father='$father', fatheroccupation='$occupation', fathercontact='$fathercontact', mother='$mother', motheroccupation='$motheroccupation', mothercontact='$mothercontact', address='$address', elementarygraduated='$grad',
                                                            	     
                                                                 average='$average', requirements = '$b', process='$process', date=NOW(), kindofuser ='$kindofuser', schoolyear='$schoolyear', section='$sectionname', adviser='$adviser' WHERE username='$_SESSION[email]'";
