                                                  ...
                                                  $adviser = $rowsection['adviser'];
                                                        ...
                                                        while($rowcount = mysqli_fetch_array($resultcount))
                                                        {
                                                          ...
                                                          if($rowcount[0] >='2')
                                                                              ...
                                                                              while($rowcount2 = mysqli_fetch_array($resultcount2))
                                                                                   {
                                                                                      ...
                                                                                      {
                                                                                        $query = "UPDATE enrollmentform SET sname='$surname', fname='$firstname', mname='$mname', email='$email', placeofbirth='$birthplace', gender='$gen', dateofbirth='$bday', age='$age', grade='$grade', father='$father', fatheroccupation='$occupation', fathercontact='$fathercontact', mother='$mother', motheroccupation='$motheroccupation', mothercontact='$mothercontact', address='$address', elementarygraduated='$grad', average='$average', requirements = '$b',  process='$process', date=NOW(), kindofuser ='$kindofuser', schoolyear='$schoolyear', section='$sectionname2', adviser='$adviser2' WHERE username='$_SESSION[email]'";
                                                              ...
                                                              {
                                                                      $query = "UPDATE enrollmentform SET sname='$surname', fname='$firstname', mname='$mname', email='$email', placeofbirth='$birthplace', gender='$gen', dateofbirth='$bday', age='$age', grade='$grade', father='$father', mother='$mother', motheroccupation='$motheroccupation', fatheroccupation='$occupation', fathercontact='$fathercontact', mothercontact='$mothercontact', address='$address', elementarygraduated='$grad', average='$average', requirements = '$b',  process='$process', date=NOW(), kindofuser ='$kindofuser', schoolyear='$schoolyear', section='$sectionname', adviser='$adviser' WHERE username='$_SESSION[email]'";
