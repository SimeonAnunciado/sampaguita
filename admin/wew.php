...
if(isset($id)){
	$que = "SELECT * FROM registereduser WHERE id = '$id' limit 0,1";
	...
	<br><br><br>
		...
		<div class="row" style="padding-top: 20px;">
			...
			if (isset($_POST['update'])) {
				...
				$que = "UPDATE registereduser SET pass = '$pass' WHERE id ='$id' ";
			...
			<!-- Form -->
			 ...
			 <form class="form-horizontal" action="" method="POST" id="form">
					 <?php 
					$query = mysqli_query($db,"SELECT * FROM registereduser WHERE id ='$id' ");
