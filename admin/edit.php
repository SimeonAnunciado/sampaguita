...
if(isset($id)){
	$que = "SELECT * FROM studentdetails WHERE id = '$id' limit 0,1";
	...
	<br><br><br>
		...
		<div class="row" style="padding-top: 20px;">
			...
			if (isset($_POST['update'])) {
				...
				$que = "UPDATE studentdetails SET username= '$em', password = '$pass' WHERE id ='$id' ";
			...
			<!-- Form -->
			 ...
			 <form class="form-horizontal" action="" method="POST" id="form">
	              ...
	              <label class="control-label col-sm-3" for="fname">Student No.</label>
	              <div class="col-sm-8">
	                <input type="text" class="form-control" id="fname" name="fname" value="<?php echo $row['stno'];?>" disabled>
	              </div>
	            </div>

	            <div class="form-group">
	              <label class="control-label col-sm-3" for="lname">Student Name</label>
	              <div class="col-sm-8"> 
	                <input type="text" class="form-control" id="lname" name="lname" value="<?php echo $row['stname'];?>">
	              </div>
	              </div>
	              ...
	              <div class="form-group">
					...
					?>
					 <div class="form-group">
		              ...
		              <div class="col-sm-8"> 
	         	      <input type="text" class="form-control" id="pass1" name="password" required>
	            	  </div>
		          </div>
		          <div class="form-group">
