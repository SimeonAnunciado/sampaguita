...
<div class="row" style="padding-top: 20px;">
      ...
      <?php 
        ...
        if(empty($requirements) AND empty($b)){
          echo 
            '<div class="alert alert-danger alert-dismissable">
              <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
              <strong>Oops!</strong> Please Select Atleast 1 Student Requirements
            </div>';
       ...
       // $gradesession = $_SESSION['grade'] = $grade;
      ...
      <div class="panel panel-primary">
        ...
        <div class="panel-body">
         ...
         id="Form-validation" >
           ...
           <?php 
           $query = mysqli_query($db,"SELECT * FROM enrollmentform WHERE stno ='$stno' AND grade = '$sessiongrade'  ");
          if ($row = mysqli_fetch_array($query)) {
           ...
           <div class="form-group">
              ...
              <hr>
               ...
               <div class="form-group">
                  <label class="control-label col-sm-3" for="address">Section</label>
                  <div class="col-sm-8"> 
                  <input type="text" class="form-control" id="address" 
                  value="<?php echo $row['section'];?>"  required>
                  </div>
              </div>
              <div class="form-group">
                  <label class="control-label col-sm-3" for="address">Adviser</label>
                  <div class="col-sm-8"> 
                  <input type="text" class="form-control" id="address"  
           ...
           <div class="form-group">
              ...
              <div class="form-group">
                <div class="col-md-12">
                  <label class="checkbox-inline"></label>
                   <input type="text" readonly="readonly" name="requirementslist" class="form-control" 
                   value="<?php echo
