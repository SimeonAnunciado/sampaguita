...
<?php $sqlsection= "SELECT * FROM sectionlist WHERE criteria ='80' && grade ='$grade' && schoolyear='$schoolyear'";
                                                ...
                                                $sqlcount = "SELECT count(id) FROM enrollmentform WHERE section = '$sectionname'&& schoolyear ='$schoolyear'";        
                                                        ...
                                                        while($rowcount = mysqli_fetch_array($resultcount))
                                                        {
                                                          ...
                                                          echo"<br>";
                                                           if($rowcount[0] >='2')
                                                              {
                                                                $sqlsection3= "SELECT * FROM sectionlist WHERE criteria ='80a' && grade ='$grade' && schoolyear='$schoolyear'";
