...
<br><br>
<br><br>
  <div class="container" style="position: relative; top: -60px; margin-bottom: 90px;">
    <div class="row">
    <?php
      ...
      <div class="col-md-12">
        <div class="panel panel-primary" ">
          <div class="panel-heading">
            <div class="panel-title">Admin And Chairman</div>
          </div>
          <div class="panel-body">
          </div>
          <div class="table-container table-responsive">
          <table class="table table-hover table-condensed table-bordered" style="padding: 10px;">
            <thead>
              <tr>
                <th width="20%"><center>Username</center></th>
                <th width="20%"><center>Password</center></th>
                <th width="20%"><center>Kind of User</center></th>
                <th width="20%"><center>User Level</center></th>
            ...
            <tbody>
               <?php
                ...
                <tr>
                  ...
                  <td class="text-center"><?php echo$pass;?></td>
                  <td class="text-center"><?php echo$userlvl;?></td>
                  <td class="text-center"><?php echo$kindofuser;?></td>
                  <td class="text-center"><a href="view.php?id=<?php echo $id?>" class="btn btn-info">View</a></td>
                </tr>
                 <?php
                  }
                  ?>
