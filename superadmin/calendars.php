...
<br><br>
  <div class="container" style="position: relative; top: -60px; margin-bottom: 190px;">
    <div class="row">
          <?php 
         $query = mysqli_query($db,"SELECT * FROM calendar WHERE id = '$id' ");
         ...
         $update = mysqli_query($db,"UPDATE calendar SET day ='$day' , event = '$event' WHERE id = '$id' ");
         if ($update) {
            ?>
            <div class="container">
              <div class="row">
                ...
                <div class="col-md-10">
                   <div class="alert alert-success alert-dismissable fade in">
                    ...
                    <strong>Success!</strong> Updating
                  </div>
                </div>
                <div class="col-md-1"></div>
              </div>
      ...
      <div class="col-md-1"></div>
      <div class="col-md-10" style="margin: 0px 0px 90px 0px;">
        <div class="panel panel-primary">
          ...
          <form method="POST" action="" class="form-horizontal">
           ...
           <div class="form-group">
            ...
            <div class="col-sm-7">
              <input type="date" class="form-control" name="day" id="email" placeholder="Enter email"
              value="<?php echo $day; ?>">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-7">          
             <textarea class="form-control" name="event" id="pwd" rows="5" placeholder="Enter password">
             <?php echo $event; ?> </textarea>
            </div>
          </div>
