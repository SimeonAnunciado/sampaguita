      ...
      <div class="col-md-12">
        <div class="panel panel-primary">
          ...
          <table class="table table-hover table-condensed table-bordered">
            <thead>
              <tr>
                <th width="20%"><center>Students No.</center></th>
                <th width="20%"><center>Students Name</center></th>
            ...
            <tbody>
               <?php
                ...
                ?>
                <tr>
                  <td class="text-center"><?php echo$stno;?></td>
                  <td class="text-center"><?php echo$name;?></td>
                  <td class="text-center"><?php echo$user;?></td>
                  <td class="text-center"><?php echo$pass;?></td>
                  <td class="text-center"><a href="viewstudent.php?id=<?php echo $row['id']; ?>" class="btn btn-info ">View</a>
                  </td>
                </tr>
                 <?php
                  }
