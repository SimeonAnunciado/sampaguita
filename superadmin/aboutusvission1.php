          ...
          <div class="panel-body">
            <div class="col-md-12">
                   <ul class="nav nav-tabs">
                    <li><a href="aboutus1.php"><b>Mission</b></a></li>
                    <li class="active"><a href="aboutusvission1.php"><b>Vission</b></a></li>
                  </ul>
                  <br>
              <div class="well">
                <?php
                if(isset($_POST['savebtn']))
                {
                  ...
                  $desc = $_POST['desc'];
                  $sql="UPDATE aboutus SET vission ='$desc', date=Now() WHERE id='1'";
               ...
               <textarea class="form-control" name="desc" rows="30" style="font-style: italic;" id="requirements" disabled><?php echo$desc; ?> </textarea>
                <br>
