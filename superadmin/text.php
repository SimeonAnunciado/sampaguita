            ...
            <tbody>
               <?php
                ...
                <tr>
                  ...
                  <td class="text-center"><a href="viewtext.php?id=<?php echo $row['id']; ?>" class="btn btn-info ">View</a>
             <a href="deletetext.php?id=<?php echo $row['id']; ?>" class="btn btn-danger ">Delete</a>
                  </td>
                </tr>
                 <?php
                  }
